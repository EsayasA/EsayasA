...
I build practical AI-powered applications using modern backend, frontend, and machine learning tools.
...
I'm an **AI Engineer** and **Software Developer** currently pursuing a **Master's degree in Artificial Intelligence**. I'm passionate about designing and building intelligent software systems that combine modern AI with scalable software engineering.
...
![REST API](https://img.shields.io/badge/REST_API-Backend-005571?style=for-the-badge)
...
A modern **AI-powered Applicant Tracking System (ATS)** built with **Next.js**, **FastAPI**, and **Ollama**.

### ✨ Features

- 🧠 Semantic resume matching with Ollama embeddings
- 📄 PDF resume parsing
- 📊 AI candidate ranking & match scoring
...
A Retrieval-Augmented Generation assistant for private knowledge bases.
...
## 👁️ Open-Vocabulary Object Tracker

An AI computer vision project combining multiple foundation models.

### ✨ Features

- 🎯 Open-vocabulary object detection
- ✂️ Automatic segmentation
